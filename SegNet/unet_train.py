...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_path", type=str, default="my_checkpoint.pth.tar", help="Path to save/load checkpoint")
    parser.add_argument("--log_dir", type=str, default="C:/Inmind/PROJECT/SegNet/runs", help="Directory for TensorBoard logs")
    parser.add_argument("--train_img_dir", type=str, default="C:/Inmind/PROJECT/SegNet/segnet_dataset/Images/segnet_train", help="Directory for training images")
    parser.add_argument("--train_mask_dir", type=str, default="C:/Inmind/PROJECT/SegNet/segnet_dataset/Masks/segnet_train", help="Directory for training masks")
    parser.add_argument("--val_img_dir", type=str, default="C:/Inmind/PROJECT/SegNet/segnet_dataset/Images/segnet_val", help="Directory for validation images")
    parser.add_argument("--val_mask_dir", type=str, default="C:/Inmind/PROJECT/SegNet/segnet_dataset/Masks/segnet_val", help="Directory for validation masks")
    parser.add_argument("--label_dir", type=str, default="C:/Inmind/PROJECT/SegNet/segnet_dataset/Labels", help="Directory for labels")
