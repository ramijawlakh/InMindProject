...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_img_dir", type=str, default="/content/drive/MyDrive/segnet_dataset/Images/segnet_train", help="Directory for training images")
    parser.add_argument("--train_mask_dir", type=str, default="/content/drive/MyDrive/segnet_dataset/Masks/segnet_train", help="Directory for training masks")
    parser.add_argument("--val_img_dir", type=str, default="/content/drive/MyDrive/segnet_dataset/Images/segnet_val", help="Directory for validation images")
    parser.add_argument("--val_mask_dir", type=str, default="/content/drive/MyDrive/segnet_dataset/Masks/segnet_val", help="Directory for validation masks")
    parser.add_argument("--label_dir", type=str, default="/content/drive/MyDrive/segnet_dataset/Labels", help="Directory for labels")
